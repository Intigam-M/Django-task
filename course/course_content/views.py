...
from .forms import TagForm, CourseForm, LessonForm, CourseSearchForm, CoursePriceForm
...
def create_course(request):
    ...
    return render(request,'create-course.html',context={'form':form, 'courses':courses})    
...
def create_lesson(request, pk):
    ...
    return render(request, 'create-lesson.html', context={'form':form, 'lessons':lessons})
...
def create_tag(request):
    ...
    tags = Tag.objects.all()        
    return render(request,'create-tag.html', context={'form':form, 'tags':tags})
